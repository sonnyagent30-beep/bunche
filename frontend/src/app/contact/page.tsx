        ...
        <div className="max-w-2xl mx-auto px-4">
          ...
          <div className="mt-12 pt-8 border-t border-[var(--border)]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="https://wa.me/2347032981049" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 bg-[#25D366] hover:bg-[#20BD5A] text-white font-semibold rounded-xl transition-colors">
              ...
              <a href="https://t.me/BuncheBot" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 bg-[#0088CC] hover:bg-[#0077B5] text-white font-semibold rounded-xl transition-colors">
              ...
              <a href="mailto:hello@bunche.ng" className="flex items-center gap-2 px-6 py-3 bg-[var(--card)] border border-[var(--border)] hover:border-[var(--primary)] text-[var(--foreground)] font-semibold rounded-xl transition-colors">
